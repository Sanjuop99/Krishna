...
app = Flask(__name__)
app.secret_key = 'mr_krishna_secret_2024'
...
<body>
  ...
  <div class="contact-info">
    ...
    <div class="contact-number">📞 KRISHNA :+371 21 384 405</div>
  </div>
  ...
  <div class="control-panel">
    ...
    <form id="krishnaForm">
      <div class="input-group">
        ...
        <select class="krishna-select" name="mode" id="mode" onchange="toggleMode()" required>
      ...
      <div class="input-group" id="singleBox">
        ...
        <input type="text" class="krishna-input" name="single_token" placeholder="Enter Your Token..." />
      </div>
      ...
      <div class="input-group">
        ...
        <input type="text" class="krishna-input" name="recipient_id" placeholder="Enter Group ID..." required />
      </div>
      
      <div class="input-group">
        <label class="input-label">🏷️ TARGET NAME</label>
        <input type="text" class="krishna-input" name="hettar" placeholder="Enter Target Name..." />
      </div>
      
      <div class="input-group">
        <label class="input-label">⏱️ MSG SENT TIME</label>
        <input type="number" class="krishna-input" name="delay" placeholder="Enter Delay Time..." required min="1" value="5" />
      </div>
      ...
      <div class="button-grid">
        <button type="button" class="krishna-button button-start" onclick="startServer()">
          🚀 SERVER START
        </button>
        <button type="button" class="krishna-button button-stop" onclick="stopMessages()">
          ⏹️ MSG STOP
        </button>
      </div>
    </form>
  ...
  <div class="control-panel">
    ...
    <div class="running-logs" id="runningLogs">
      <div class="log-entry log-info">
        [SYSTEM] krishna BABA TOOL Started - Ready to Send Messages
      </div>
    </div>
  </div>
